...
from highcharts_maps.options.series.timeline import TimelineSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/timeline/01.js', False, None),
    ('series/timeline/02.js', False, None),

    ('series/timeline/error-01.js',
     False,
    ...
    ('series/timeline/01.js', True, None),
    ('series/timeline/02.js', True, None),
