################################################################
:mod:`.plot_options <highcharts_maps.options.plot_options>`
################################################################
...
.. module:: highcharts_maps.options.plot_options

********************************************************************************************************************
class: :class:`PlotOptions <highcharts_maps.options.plot_options.PlotOptions>`
********************************************************************************************************************
