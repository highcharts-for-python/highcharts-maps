...
from highcharts_maps.options.series.sankey import SankeySeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/sankey/01.js', False, None),
    ('series/sankey/02.js', False, None),

    ('series/sankey/error-01.js',
     False,
    ...
    ('series/sankey/01.js', True, None),
    ('series/sankey/02.js', True, None),
