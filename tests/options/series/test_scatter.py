...
from highcharts_maps.options.series.scatter import ScatterSeries as cls
from highcharts_maps.options.series.scatter import Scatter3DSeries as cls2
...
def test_ScatterSeries__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_ScatterSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_ScatterSeries_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_ScatterSeries_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('series/scatter/01.js', False, None),
    ('series/scatter/02.js', False, None),

    ('series/scatter/error-01.js',
     False,
    ...
    ('series/scatter/01.js', True, None),
    ('series/scatter/02.js', True, None),
...
def test_ScatterSeries_from_js_literal(input_files, filename, as_file, error):
...
@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_Scatter3DSeries__init__(kwargs, error):
    Class__init__(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_Scatter3DSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_Scatter3DSeries_from_dict(kwargs, error):
    Class_from_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_Scatter3DSeries_to_dict(kwargs, error):
...
def test_Scatter3DSeries_from_js_literal(input_files, filename, as_file, error):
