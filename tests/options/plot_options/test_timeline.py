...
from highcharts_maps.options.plot_options.timeline import TimelineOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/timeline/01.js', False, None),
    ('plot_options/timeline/02.js', False, None),

    ('plot_options/timeline/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/timeline/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/timeline/01.js', True, None),
    ('plot_options/timeline/02.js', True, None),
