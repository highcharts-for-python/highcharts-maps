...
from highcharts_maps.options.plot_options.dependencywheel import DependencyWheelOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/dependencywheel/01.js', False, None),
    ('plot_options/dependencywheel/02.js', False, None),

    ('plot_options/dependencywheel/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/dependencywheel/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/dependencywheel/01.js', True, None),
    ('plot_options/dependencywheel/02.js', True, None),
