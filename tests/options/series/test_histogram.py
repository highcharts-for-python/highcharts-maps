...
from highcharts_maps.options.series.histogram import HistogramSeries as cls
...
def test_HistogramSeries__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_HistogramSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_HistogramSeries_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_HistogramSeries_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('series/histogram/01.js', False, None),

    ('series/histogram/error-01.js',
     False,
    ...
    ('series/histogram/01.js', True, None),
...
def test_HistogramSeries_from_js_literal(input_files, filename, as_file, error):
