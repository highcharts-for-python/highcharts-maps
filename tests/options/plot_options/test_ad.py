...
from highcharts_maps.options.plot_options.ad import ADOptions as cls
...
def test_ADOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_ADOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_ADOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_ADOptions_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/ad/01.js', False, None),
    ('plot_options/ad/error-01.js',
     False,
    ...
    ('plot_options/ad/01.js', True, None),
    ('plot_options/ad/error-01.js',
     True,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
...
def test_ADOptions_from_js_literal(input_files, filename, as_file, error):
