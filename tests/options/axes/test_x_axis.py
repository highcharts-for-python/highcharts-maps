...
from highcharts_maps.options.axes.x_axis import XAxis as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('axes/x_axis/01.js', False, None),
    ('axes/x_axis/02.js', False, None),

    ('axes/x_axis/error-01.js',
     False,
    ...
    ('axes/x_axis/01.js', True, None),
    ('axes/x_axis/02.js', True, None),
