...
from highcharts_maps.options.plot_options.organization import OrganizationOptions as cls
...
STANDARD_PARAMS = [
    ...
    ({
      'hanging_indent': 24,
      'hanging_indent_translation': 'inherit',
      'levels': [
          {
           'colorByPoint': False,
           'linkOpacity': 0.5,
...
def test_OrganizationOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_OrganizationOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_OrganizationOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_OrganizationOptions_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/organization/01.js', False, None),
    ('plot_options/organization/02.js', False, None),

    ('plot_options/organization/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/organization/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/organization/01.js', True, None),
    ('plot_options/organization/02.js', True, None),
...
def test_OrganizationOptions_from_js_literal(input_files, filename, as_file, error):
