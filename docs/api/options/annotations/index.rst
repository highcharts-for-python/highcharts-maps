################################################################
:mod:`.annotations <highcharts_maps.options.annotations>`
################################################################
...
.. module:: highcharts_maps.options.annotations

****************************************************************************************
class: :class:`Annotation <highcharts_maps.options.annotations.Annotation>`
****************************************************************************************
