...
from highcharts_maps.options.plot_options.wordcloud import WordcloudOptions as cls
...
STANDARD_PARAMS = [
    ({}, None),
    ({
      'allow_extend_playing_field': False,
      'animation_limit': 10,
      'border_color': '#ccc',
      'border_radius': 2,
      'border_width': 1,
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/wordcloud/01.js', False, None),
    ('plot_options/wordcloud/02.js', False, None),

    ('plot_options/wordcloud/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/wordcloud/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/wordcloud/01.js', True, None),
    ('plot_options/wordcloud/02.js', True, None),
