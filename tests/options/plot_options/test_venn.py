...
from highcharts_maps.options.plot_options.venn import VennOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/venn/01.js', False, None),
    ('plot_options/venn/02.js', False, None),

    ('plot_options/venn/error-01.js',
     False,
    ...
    ('plot_options/venn/01.js', True, None),
    ('plot_options/venn/02.js', True, None),
