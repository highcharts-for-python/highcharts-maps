...
from highcharts_maps.options.plot_options.arcdiagram import ArcDiagramOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/arcdiagram/01.js', False, None),
    ('plot_options/arcdiagram/02.js', False, None),

    ('plot_options/arcdiagram/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/arcdiagram/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/arcdiagram/01.js', True, None),
    ('plot_options/arcdiagram/02.js', True, None),
