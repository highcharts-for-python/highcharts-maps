...
from highcharts_maps.options.plot_options.vector import VectorOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/vector/01.js', False, None),
    ('plot_options/vector/02.js', False, None),

    ('plot_options/vector/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/vector/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/vector/01.js', True, None),
    ('plot_options/vector/02.js', True, None),
