...
from highcharts_maps.options.series.funnel import FunnelSeries as cls
from highcharts_maps.options.series.funnel import Funnel3DSeries as cls2
...
def test_FunnelSeries__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_FunnelSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_FunnelSeries_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_FunnelSeries_to_dict(kwargs, error):
...
def test_FunnelSeries_from_js_literal(input_files, filename, as_file, error):
...
def test_Funnel3DSeries__init__(kwargs, error):
    Class__init__(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS_2)
def test_Funnel3DSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_Funnel3DSeries_from_dict(kwargs, error):
    Class_from_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_Funnel3DSeries_to_dict(kwargs, error):
...
def test_Funnel3DSeries_from_js_literal(input_files, filename, as_file, error):
