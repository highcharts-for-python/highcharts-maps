...
from highcharts_maps.options.plot_options.boxplot import BoxPlotOptions as cls
from highcharts_maps.options.plot_options.boxplot import ErrorBarOptions as cls2
