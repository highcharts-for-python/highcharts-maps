...
from highcharts_maps.options.series.wordcloud import WordcloudSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/wordcloud/01.js', False, None),
    ('series/wordcloud/02.js', False, None),

    ('series/wordcloud/error-01.js',
     False,
    ...
    ('series/wordcloud/01.js', True, None),
    ('series/wordcloud/02.js', True, None),
