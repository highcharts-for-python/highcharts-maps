...
from highcharts_maps.options.plot_options.heatmap import HeatmapOptions as cls
from highcharts_maps.options.plot_options.heatmap import TilemapOptions as cls2
...
def test_HeatmapOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_HeatmapOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_HeatmapOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_HeatmapOptions_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/heatmap/01.js', False, None),
    ('plot_options/heatmap/02.js', False, None),

    ('plot_options/heatmap/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/heatmap/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/heatmap/01.js', True, None),
    ('plot_options/heatmap/02.js', True, None),
...
def test_HeatmapOptions_from_js_literal(input_files, filename, as_file, error):
...
def test_TilemapOptions__init__(kwargs, error):
    Class__init__(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS_2)
def test_TilemapOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_TilemapOptions_from_dict(kwargs, error):
    Class_from_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_TilemapOptions_to_dict(kwargs, error):
    Class_to_dict(cls2, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/heatmap/03.js', False, None),
    ('plot_options/heatmap/04.js', False, None),

    ('plot_options/heatmap/error-03.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
      TypeError,
      ValueError)),
    ('plot_options/heatmap/error-04.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/heatmap/03.js', True, None),
    ('plot_options/heatmap/04.js', True, None),
...
def test_TilemapOptions_from_js_literal(input_files, filename, as_file, error):
