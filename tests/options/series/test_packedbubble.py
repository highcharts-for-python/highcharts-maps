...
from highcharts_maps.options.series.packedbubble import PackedBubbleSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/packedbubble/01.js', False, None),
    ('series/packedbubble/02.js', False, None),

    ('series/packedbubble/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('series/packedbubble/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('series/packedbubble/01.js', True, None),
    ('series/packedbubble/02.js', True, None),
