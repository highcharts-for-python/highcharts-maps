...
from highcharts_maps.options.series.item import ItemSeries as cls
...
def test_ItemSeries__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_ItemSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_ItemSeries_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_ItemSeries_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('series/item/01.js', False, None),
    ('series/item/02.js', False, None),

    ('series/item/error-01.js',
     False,
    ...
    ('series/item/01.js', True, None),
    ('series/item/02.js', True, None),
...
def test_ItemSeries_from_js_literal(input_files, filename, as_file, error):
