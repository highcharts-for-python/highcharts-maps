...
from highcharts_maps.options.plot_options.treemap import TreemapOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/treemap/01.js', False, None),
    ('plot_options/treemap/02.js', False, None),

    ('plot_options/treemap/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/treemap/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/treemap/01.js', True, None),
    ('plot_options/treemap/02.js', True, None),
