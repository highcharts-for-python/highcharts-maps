...
class SharedMapsOptions(HighchartsMapsOptions):
    ...
    def from_options(cls, options):
        ...
        :param options: A :class:`HighchartsMapsOptions` object to use for the shared
          options instance.
        :type options:
          :class:`HighchartsMapsOptions <highcharts_maps.options.HighchartsMapsOptions>`
          or coercable
        ...
        :returns: A
          :class:`SharedMapsOptions <highcharts_maps.global_options.shared_options.SharedMapsOptions>`
          instance
          :rtype: :class:`SharedMapsOptions <highcharts_maps.global_options.shared_options.SharedMapsOptions>`
        """
        if not options:
            return cls()

        options = validate_types(options, types = (HighchartsMapsOptions))
