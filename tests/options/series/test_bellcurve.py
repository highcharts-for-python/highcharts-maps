...
from highcharts_maps.options.series.bellcurve import BellCurveSeries as cls
...
def test_BellCurveSeries__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_BellCurveSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_BellCurveSeries_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_BellCurveSeries_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('series/bellcurve/01.js', False, None),

    ('series/bellcurve/error-01.js',
     False,
    ...
    ('series/bellcurve/01.js', True, None),
...
def test_BellCurveSeries_from_js_literal(input_files, filename, as_file, error):
