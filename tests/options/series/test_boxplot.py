...
from highcharts_maps.options.series.boxplot import BoxPlotSeries as cls
from highcharts_maps.options.series.boxplot import ErrorBarSeries as cls2
...
def test_BoxPlotSeries__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_BoxPlotSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_BoxPlotSeries_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_BoxPlotSeries_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('series/boxplot/01.js', False, None),

    ('series/boxplot/error-01.js',
     False,
    ...
    ('series/boxplot/01.js', True, None),
...
def test_BoxPlotSeries_from_js_literal(input_files, filename, as_file, error):
...
def test_ErrorBarSeries__init__(kwargs, error):
    Class__init__(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS_2)
def test_ErrorBarSeries__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_ErrorBarSeries_from_dict(kwargs, error):
    Class_from_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_ErrorBarSeries_to_dict(kwargs, error):
    Class_to_dict(cls2, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('series/boxplot/02.js', False, None),

    ('series/boxplot/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('series/boxplot/02.js', True, None),
...
def test_ErrorBarSeries_from_js_literal(input_files, filename, as_file, error):
