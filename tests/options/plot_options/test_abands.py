...
from highcharts_maps.options.plot_options.abands import AbandsOptions as cls
from highcharts_maps.options.plot_options.abands import PCOptions as cls2
from highcharts_maps.options.plot_options.abands import KeltnerChannelsOptions as cls3
from highcharts_maps.options.plot_options.abands import BBOptions as cls4
...
def test_AbandsOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_AbandsOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_AbandsOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_AbandsOptions_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/abands/01.js', False, None),
    ('plot_options/abands/error-01.js',
     False,
    ...
    ('plot_options/abands/01.js', True, None),
    ('plot_options/abands/error-01.js',
     True,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
...
def test_AbandsOptions_from_js_literal(input_files, filename, as_file, error):
...
def test_PCOptions__init__(kwargs, error):
    Class__init__(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS_2)
def test_PCOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_PCOptions_from_dict(kwargs, error):
    Class_from_dict(cls2, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_2)
def test_PCOptions_to_dict(kwargs, error):
    Class_to_dict(cls2, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/abands/02.js', False, None),
    ('plot_options/abands/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/abands/02.js', True, None),
    ('plot_options/abands/error-02.js',
     True,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
...
def test_PCOptions_from_js_literal(input_files, filename, as_file, error):
...
@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_KeltnerChannelsOptions__init__(kwargs, error):
    Class__init__(cls3, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_KeltnerChannelsOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls3, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_KeltnerChannelsOptions_from_dict(kwargs, error):
    Class_from_dict(cls3, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_KeltnerChannelsOptions_to_dict(kwargs, error):
    Class_to_dict(cls3, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/abands/03.js', False, None),
    ('plot_options/abands/error-03.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/abands/03.js', True, None),
    ('plot_options/abands/error-03.js',
     True,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
...
def test_KeltnerChannelsOptions_from_js_literal(input_files, filename, as_file, error):
...
def test_BBOptions__init__(kwargs, error):
    Class__init__(cls4, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS_3)
def test_BBOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls4, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_3)
def test_BBOptions_from_dict(kwargs, error):
    Class_from_dict(cls4, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS_3)
def test_BBOptions_to_dict(kwargs, error):
    Class_to_dict(cls4, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/abands/04.js', False, None),
    ('plot_options/abands/error-04.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/abands/04.js', True, None),
    ('plot_options/abands/error-04.js',
     True,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
...
def test_BBOptions_from_js_literal(input_files, filename, as_file, error):
