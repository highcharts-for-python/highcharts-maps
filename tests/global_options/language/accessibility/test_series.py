...
from highcharts_maps.global_options.language.accessibility.series import SeriesTypeDescriptions as cls
from highcharts_maps.global_options.language.accessibility.series import SeriesLanguageOptions as cls2
