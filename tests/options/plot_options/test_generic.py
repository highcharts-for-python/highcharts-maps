...
from highcharts_maps.options.plot_options.generic import GenericTypeOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/generic/01.js', False, None),

    ('plot_options/generic/error-01.js',
     False,
    ...
    ('plot_options/generic/01.js', True, None),
