...
from highcharts_maps.options.plot_options.histogram import HistogramOptions as cls
...
STANDARD_PARAMS = [
    ({}, None),
    ({
      'bins_number': 'square-root',
      'bin_width': 24
    }, None),
    ({
      'bins_number': """function(baseSeries) { return true; }""",
      'bin_width': 24
    }, None),
    # + Bar Options
    ({
...
def test_HistogramOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_HistogramOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_HistogramOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_HistogramOptions_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/histogram/01.js', False, None),
    ('plot_options/histogram/02.js', False, None),
    ('plot_options/histogram/03.js', False, None),

    ('plot_options/histogram/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/histogram/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/histogram/01.js', True, None),
    ('plot_options/histogram/02.js', True, None),
    ('plot_options/histogram/03.js', True, None),
...
def test_HistogramOptions_from_js_literal(input_files, filename, as_file, error):
