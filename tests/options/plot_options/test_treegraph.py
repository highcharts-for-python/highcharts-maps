...
from highcharts_maps.options.plot_options.treegraph import TreegraphOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/treegraph/01.js', False, None),
    ('plot_options/treegraph/02.js', False, None),

    ('plot_options/treegraph/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/treegraph/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/treegraph/01.js', True, None),
    ('plot_options/treegraph/02.js', True, None),
