...
from highcharts_maps.options.series.bubble import BubbleSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/bubble/01.js', False, None),

    ('series/bubble/error-01.js',
     False,
