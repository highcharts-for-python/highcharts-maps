...
from highcharts_maps.options.plot_options.bubble import BubbleOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/bubble/01.js', False, None),
    ('plot_options/bubble/02.js', False, None),

    ('plot_options/bubble/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/bubble/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/bubble/01.js', True, None),
    ('plot_options/bubble/02.js', True, None),
