...
from highcharts_maps.options.series.networkgraph import NetworkGraphSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/networkgraph/01.js', False, None),
    ('series/networkgraph/02.js', False, None),

    ('series/networkgraph/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('series/networkgraph/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('series/networkgraph/01.js', True, None),
    ('series/networkgraph/02.js', True, None),
