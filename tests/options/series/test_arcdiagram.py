...
from highcharts_maps.options.series.arcdiagram import ArcDiagramSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/arcdiagram/01.js', False, None),

    ('series/arcdiagram/error-01.js',
     False,
    ...
    ('series/arcdiagram/01.js', True, None),
