#################################################################
:mod:`.language <highcharts_maps.global_options.language>`
#################################################################
...
.. module:: highcharts_maps.global_options.language

******************************************************************************************
class: :class:`Language <highcharts_maps.global_options.language.Language>`
******************************************************************************************
