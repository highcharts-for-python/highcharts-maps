...
from highcharts_maps.options.series.pareto import ParetoSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/pareto/01.js', False, None),
    ('series/pareto/02.js', False, None),

    ('series/pareto/error-01.js',
     False,
    ...
    ('series/pareto/01.js', True, None),
    ('series/pareto/02.js', True, None),
