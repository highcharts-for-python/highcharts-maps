...
from highcharts_maps.options.series.data.range import RangeData as cls
from highcharts_maps.options.series.data.range import ConnectedRangeData as cls2
