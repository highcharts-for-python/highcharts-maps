...
from highcharts_maps.options.plot_options.arcdiagram import ArcDiagramOptions
from highcharts_maps.options.plot_options.area import AreaOptions
from highcharts_maps.options.plot_options.area import AreaRangeOptions
from highcharts_maps.options.plot_options.area import AreaSplineOptions
from highcharts_maps.options.plot_options.area import AreaSplineRangeOptions
from highcharts_maps.options.plot_options.bar import BarOptions
from highcharts_maps.options.plot_options.bellcurve import BellCurveOptions
from highcharts_maps.options.plot_options.boxplot import BoxPlotOptions
from highcharts_maps.options.plot_options.bubble import BubbleOptions
from highcharts_maps.options.plot_options.bullet import BulletOptions
from highcharts_maps.options.plot_options.bar import ColumnOptions
from highcharts_maps.options.plot_options.bar import ColumnPyramidOptions
from highcharts_maps.options.plot_options.bar import ColumnRangeOptions
from highcharts_maps.options.plot_options.bar import CylinderOptions
...
from highcharts_maps.options.plot_options.heatmap import HeatmapOptions
from highcharts_maps.options.plot_options.histogram import HistogramOptions
from highcharts_maps.options.plot_options.item import ItemOptions
from highcharts_maps.options.plot_options.area import LineOptions
from highcharts_maps.options.plot_options.dumbbell import LollipopOptions
from highcharts_maps.options.plot_options.networkgraph import NetworkGraphOptions
...
from highcharts_maps.options.plot_options.pyramid import Pyramid3DOptions
from highcharts_maps.options.plot_options.sankey import SankeyOptions
from highcharts_maps.options.plot_options.scatter import ScatterOptions
from highcharts_maps.options.plot_options.scatter import Scatter3DOptions
from highcharts_maps.options.plot_options.series import SeriesOptions
from highcharts_maps.options.plot_options.gauge import SolidGaugeOptions
from highcharts_maps.options.plot_options.spline import SplineOptions
from highcharts_maps.options.plot_options.area import StreamGraphOptions
...
from highcharts_maps.options.plot_options.vector import VectorOptions
from highcharts_maps.options.plot_options.venn import VennOptions
from highcharts_maps.options.plot_options.bar import WaterfallOptions
from highcharts_maps.options.plot_options.bar import WindBarbOptions
from highcharts_maps.options.plot_options.wordcloud import WordcloudOptions
...
class PlotOptions(PlotOptionsBase):
    ...
    def map(self) -> Optional[MapOptions]:
        ...
        :rtype: :class:`MapOptions` or :obj:`None <python:None>`
        """
        return self._map
