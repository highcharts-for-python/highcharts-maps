...
from highcharts_maps.options.series.data.geometric import GeometricData
...
class MapLineSeries(MapSeriesBase, MapLineOptions):
    ...
    @property
    def data(self) -> Optional[List[GeometricData]]:
    ...
    @data.setter
    @class_sensitive(GeometricData, force_iterable = True)
    def data(self, value):
        self._data = value
