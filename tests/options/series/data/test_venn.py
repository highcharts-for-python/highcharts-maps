...
from highcharts_maps.options.series.data.venn import VennData as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/data/venn/01.js', False, None),

    ('series/data/venn/error-01.js',
     False,
    ...
    ('series/data/venn/01.js', True, None),
