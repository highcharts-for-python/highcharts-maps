...
from highcharts_maps.options.series.vector import VectorSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/vector/01.js', False, None),
    ('series/vector/02.js', False, None),

    ('series/vector/error-01.js',
     False,
    ...
    ('series/vector/01.js', True, None),
    ('series/vector/02.js', True, None),
