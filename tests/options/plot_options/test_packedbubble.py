...
from highcharts_maps.options.plot_options.packedbubble import PackedBubbleOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/packedbubble/01.js', False, None),
    ('plot_options/packedbubble/02.js', False, None),

    ('plot_options/packedbubble/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/packedbubble/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/packedbubble/01.js', True, None),
    ('plot_options/packedbubble/02.js', True, None),
