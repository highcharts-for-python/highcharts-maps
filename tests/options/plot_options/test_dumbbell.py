...
from highcharts_maps.options.plot_options.dumbbell import DumbbellOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/dumbbell/01.js', False, None),
    ('plot_options/dumbbell/02.js', False, None),

    ('plot_options/dumbbell/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/dumbbell/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/dumbbell/01.js', True, None),
    ('plot_options/dumbbell/02.js', True, None),
