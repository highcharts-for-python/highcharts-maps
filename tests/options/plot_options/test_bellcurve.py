...
from highcharts_maps.options.plot_options.bellcurve import BellCurveOptions as cls
...
def test_BellCurveOptions__init__(kwargs, error):
    Class__init__(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error', STANDARD_PARAMS)
def test_BellCurveOptions__to_untrimmed_dict(kwargs, error):
    Class__to_untrimmed_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_BellCurveOptions_from_dict(kwargs, error):
    Class_from_dict(cls, kwargs, error)


@pytest.mark.parametrize('kwargs, error',  STANDARD_PARAMS)
def test_BellCurveOptions_to_dict(kwargs, error):
    Class_to_dict(cls, kwargs, error)


@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/bellcurve/01.js', False, None),
    ('plot_options/bellcurve/02.js', False, None),

    ('plot_options/bellcurve/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/bellcurve/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/bellcurve/01.js', True, None),
    ('plot_options/bellcurve/02.js', True, None),
...
def test_BellCurveOptions_from_js_literal(input_files, filename, as_file, error):
