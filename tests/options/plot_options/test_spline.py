...
from highcharts_maps.options.plot_options.spline import SplineOptions as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('plot_options/spline/01.js', False, None),
    ('plot_options/spline/02.js', False, None),

    ('plot_options/spline/error-01.js',
     False,
     (errors.HighchartsValueError,
      ...
      TypeError,
      ValueError)),
    ('plot_options/spline/error-02.js',
     False,
     (errors.HighchartsValueError,
      errors.HighchartsParseError,
      JSONDecodeError,
    ...
    ('plot_options/spline/01.js', True, None),
    ('plot_options/spline/02.js', True, None),
