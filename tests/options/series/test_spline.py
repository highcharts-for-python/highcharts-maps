...
from highcharts_maps.options.series.spline import SplineSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/spline/01.js', False, None),
    ('series/spline/02.js', False, None),

    ('series/spline/error-01.js',
     False,
    ...
    ('series/spline/01.js', True, None),
    ('series/spline/02.js', True, None),
