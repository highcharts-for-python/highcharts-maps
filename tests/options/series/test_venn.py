...
from highcharts_maps.options.series.venn import VennSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/venn/01.js', False, None),
    ('series/venn/02.js', False, None),

    ('series/venn/error-01.js',
     False,
    ...
    ('series/venn/01.js', True, None),
    ('series/venn/02.js', True, None),
