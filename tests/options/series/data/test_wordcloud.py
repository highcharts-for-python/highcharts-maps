...
from highcharts_maps.options.series.data.wordcloud import WordcloudData as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/data/wordcloud/01.js', False, None),

    ('series/data/wordcloud/error-01.js',
     False,
    ...
    ('series/data/wordcloud/01.js', True, None),
