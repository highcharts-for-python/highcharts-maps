...
from highcharts_maps.options.series.polygon import PolygonSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/polygon/01.js', False, None),
    ('series/polygon/02.js', False, None),

    ('series/polygon/error-01.js',
     False,
    ...
    ('series/polygon/01.js', True, None),
    ('series/polygon/02.js', True, None),
